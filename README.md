...
The file "egm.proto" can be found in the installation folder of RobotWare. For example on Windows with RobotWare 6.08.00.01: 
- %localappdata%\ABB Industrial IT\Robotics IT\RobotWare\RobotWare_6.08.0135\utility\Template\EG
```
