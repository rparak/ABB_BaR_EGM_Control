...
```bash
egm.proto: Created by ABB Robotics for specifying the EGM communication protocol.
The file can be found in the installation folder of RobotWare. For example on Windows with RobotWare 6.08.00.01: 
%localappdata%\ABB Industrial IT\Robotics IT\RobotWare\RobotWare_6.08.0135\utility\Template\EGM
```
